...
APistol::APistol()
{
	...
	static ConstructorHelpers::FClassFinder<UCameraShakeBase> FireCameraShake(TEXT("Blueprint'/Game/Game/Blueprints/Weapon/Pistol/CameraShake_Pistol.CameraShake_Pistol_C'"));
